...
<template>
  <RangeCalendarCellTrigger
    :class="cn(
      ...
      // Selected
      'data-[selected]:bg-accent data-[selected]:text-accent-foreground data-[selected]:rounded-none data-[selected]:focus:bg-accent data-[selected]:focus:text-accent-foreground',
      // Disabled
